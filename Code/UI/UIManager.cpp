...
namespace Big::UserInterface
{
	...
	void UIManager::DrawOption(AbstractOption* opt, bool selected)
	{
		...
		DrawSprite("commonmenu", 0, s_PosX, m_DrawBaseY + (m_OptionHeight / 2.f), m_Width, m_OptionHeight, selected ? m_OptionSelectedBackgroundColor : m_OptionUnselectedBackgroundColor, 0);
		DrawLeftText(
			opt->GetLeftText(),
