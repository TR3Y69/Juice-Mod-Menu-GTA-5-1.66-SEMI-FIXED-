...
namespace Big::UserInterface
{
	...
	enum class BoolDisplays : std::int32_t
	{
		ON = 0,
		OFF = 1,
	};
	...
	public:
		...
		// On/Off
		float m_OnSwitchHeight = 0.025f;
		float m_OffSwitchHeight = 0.025f;
		Color m_OnSwitchColor{ 255,255,255,255 };
		Color m_OffSwitchColor{ 255,255,255,255 };
